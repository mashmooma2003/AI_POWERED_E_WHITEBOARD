...
Auto-Correction of Shapes: Automatically detects hand-drawn geometric shapes (circles, rectangles, lines, triangles) and snap-refines them into perfect geometric shapes.

Notes to PDF Export: Saves and converts entire canvas sessions or handwritten notes directly into structured PDF documents using FPDF.
